...
{
    [CustomEditor(typeof(KaiTool_DotweenUIObject))]
    public class KaiTool_DotweenUIObject_Editor : KaiTool_BasicEditor
    {

        private KaiTool_DotweenUIObject UIObject { get { return target as KaiTool_DotweenUIObject; } }

        private TabsBlock m_tabs;

        private SerializedProperty m_duration;
        private SerializedProperty m_showDelay;
        ...
        private void VariablesTab()
        {
            ...
            */
            ...
            EditorGUILayout.PropertyField(m_showDelay);
            EditorGUILayout.PropertyField(m_hideDelay);
            /*
            using (new HorizontalBlock())
            {
                GUILayout.Label("CustomDotween", EditorStyles.boldLabel, GUILayout.Width(130f));
                UIObject.m_customDotween = EditorGUILayout.Toggle(UIObject.m_customDotween);
            }
            if (UIObject.m_customDotween)
            {
                EditorGUILayout.PropertyField(m_dotweenAnimations, true);
            }
            */
